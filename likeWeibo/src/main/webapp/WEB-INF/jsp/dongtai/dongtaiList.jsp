    ...
    <div class="container-fluid" style="background: #fff;">
        ...
        <div class="collapse navbar-collapse" id="my-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="${pageContext.request.contextPath}/user/toSelfCenter"><i class="glyphicon glyphicon-user"></i>&nbsp;${loginUser.username}</a></li>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-xs-12 my_edit">
            <div class="row" id="edit_form">
                ...
                <form method="post" action="" role="form" style="margin-top: 50px;">
                    <div class="form-group">
                        <div class="col-sm-12">
